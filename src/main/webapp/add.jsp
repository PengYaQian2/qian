...
<html>
  ...
  <body>
     <form action="${ctx}/add" method="post" enctype="multipart/form-data">
       <table>
         <tr>
           <td colspan="2"><h3>添加员工信息</h3></td>
         </tr>
         <tr>
           <td>员工姓名:</td>
           ...
           <td>
             <select name="dept_id">
               ...
               <c:forEach items="${dept}" var="depts">
                 <option value="${depts.dids}">${depts.ename}</option>
               </c:forEach>
             </select>
           </td>
         </tr>
         ...
         <tr>
          ...
          <tr>
           <td colspan="2">
              <input type="submit" value="添加" id="ti">
